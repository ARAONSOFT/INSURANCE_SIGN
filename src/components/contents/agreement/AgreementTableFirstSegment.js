		...
		<Fragment className="Agreement AgreementTableFirstSegment">
			...
			<tr>
				...
				<td colSpan={3} style={TableDataWidthToObject(3)}>
					...
					>
						<table
							className="DateOfBirthTable"
							style={{ width: '3.6cm', height: '0.55cm' }}
						>
							<tr>
								<td></td>
								<td></td>
						...
						<table
							className="DateOfBirthTable"
							style={{ width: '0.6cm', height: '0.55cm' }}
						>
							<tr>
								<td></td>
							</tr>
					...
					<span
						className={classNames({
							SetBackgroundColorYellow:
								state.canvasStore[drawBoxIndex].isEmpty,
						})}
			...
			<tr>
				<td colSpan={2} style={TableDataWidthToObject(2)}>
					법정대리인(친권인)
				</td>
				<td
					style={{
